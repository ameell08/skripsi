...
connection = psycopg2.connect(
    # user="postgres", alvina
   # password="postgres123", alvina
    host="127.0.0.1",
    port="5434",
...
#--- mendefinisikan fungsi untuk mendapatkan data tanggal terakhir dari database---
...
# --- mendefinisikan fungsi untuk mengambil data komoditas rata-rata---
...
# --- mendefinisikan fungsi untuk mengambil data pasar berdasarkan kabupaten/kota---
